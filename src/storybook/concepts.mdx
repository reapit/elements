...
<Source code={`
import { FooBar, elFooMod } from 'your-component-library'
...
For example, if I were to import a `TextInput` from elements, I can apply via props all of the native props of a React `input`, contrived example below;

<Source code={`
import { TextInput } from '@reapit/elements/core/text-input'

const MyComponent = () => <TextInput type="text" onChange={(e) => console.log('Pass me to your form library!', e)} />
`} language="tsx" />
...
// Will render a "danger" button in red
const MyComponent = () => <Button intent="danger">Delete</Button>
`} language="tsx" />
