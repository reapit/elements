...
- **chore!:** Moved `MobileNavItem` from `@reapit/elements/core/mobile-nav-item` to `@reapit/elements/lab/mobile-nav-item`. It is no longer available via the root `@reapit/elements` entry point.
