...
### **5.0.0-beta.4 - 07/03/24**

- Merges in changes from v4.1.1
...
### **5.0.0-beta.2 - 04/03/24**

- Introduces all breaking changes notified in v4 for beta base line
- Deprecates legacy icon set, reduces bundle size by 2/3s
...
- For migration information see aboveimport { listenerCount } from 'process'
