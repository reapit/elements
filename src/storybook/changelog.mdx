...
### **5.0.0-beta.16 - 24/10/24**

- Introduced `Dialog` component with two size options: `small` and `medium`
- **Breaking:** The `Modal` component is deprecated and will be replaced by the `Dialog` component
