...
interface ExperimentalTableHeaderCellCSSProperties extends CSSProperties {
...
interface ElExperimentalTableHeaderCellProps {
  style?: ExperimentalTableHeaderCellCSSProperties
}

interface ElExperimentalTableHeaderCellContentProps {
  'data-alignment': string
}

export const ElExperimentalTableHeaderCell = styled.th<ElExperimentalTableHeaderCellProps>`
...
`
export const ElExperimentalTableHeaderCellContent = styled.div<ElExperimentalTableHeaderCellContentProps>`
  width: auto;
