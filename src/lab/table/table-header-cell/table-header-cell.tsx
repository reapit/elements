...
import { ElExperimentalTableHeaderCell, ElExperimentalTableHeaderCellContent } from './styles'
...
export const TableHeaderCell: FC<TableHeaderCellProps> = ({
  ...
  return (
    ...
    >
      <ElExperimentalTableHeaderCellContent data-alignment={alignment}>{children}</ElExperimentalTableHeaderCellContent>
    </ElExperimentalTableHeaderCell>
  )
}
