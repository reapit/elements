...
import {
  ElExperimentalAvatarContent,
  ElExperimentalCellContent,
  ElExperimentalMediaItemContent,
  ElExperimentalDoubleLineContent,
  ElExperimentalFirstLine,
  ElExperimentalSecondLine,
  ElExperimentalTableCell,
  ElExperimentalTableCellContent,
} from './styles'
...
export const DoubleLineCell: FC<ElDoubleLineCellProps> = ({
  ...
  const DoubleLineContents = (
    <>
      <ElExperimentalFirstLine>{firstLine}</ElExperimentalFirstLine>
      <ElExperimentalSecondLine>{secondLine}</ElExperimentalSecondLine>
    </>
  )
  ...
  return (
    ...
    >
      <ElExperimentalTableCellContent data-alignment={alignment}>
        {mediaItem ? (
          <ElExperimentalAvatarContent>
            <ElExperimentalMediaItemContent>{mediaItem}</ElExperimentalMediaItemContent>
            <ElExperimentalDoubleLineContent>{DoubleLineContents}</ElExperimentalDoubleLineContent>
          </ElExperimentalAvatarContent>
        ) : (
          <ElExperimentalCellContent>{DoubleLineContents}</ElExperimentalCellContent>
        )}
      </ElExperimentalTableCellContent>
    </ElExperimentalTableCell>
  )
