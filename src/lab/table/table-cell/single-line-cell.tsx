...
import { ElExperimentalTableCell, ElExperimentalTableCellContent } from './styles'
...
export const SingleLineCell: FC<SingleLineCellProps> = ({
  ...
  return (
    ...
    >
      <ElExperimentalTableCellContent data-alignment={alignment}>{children}</ElExperimentalTableCellContent>
    </ElExperimentalTableCell>
  )
}
