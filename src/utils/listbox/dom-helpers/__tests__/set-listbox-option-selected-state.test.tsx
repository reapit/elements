...
test('throws error when listbox does not exist', () => {
  expect(() => setListboxOptionSelectedState('non-existent-listbox', 'option1', () => true)).toThrow(ListboxError)
})
...
test('throws error when listbox has invalid structure', () => {
  ...
  expect(() => setListboxOptionSelectedState('invalid-listbox', 'option1', () => true)).toThrow(ListboxError)
})
...
test('throws error when option with specified value does not exist', () => {
  ...
  expect(() => setListboxOptionSelectedState('test-listbox', 'non-existent-option', () => true)).toThrow(ListboxError)
})
