                        ...
                        <CompactSelect size="medium">
                          ...
                          <CompactSelect.Popup>
                            <CompactSelect.Listbox defaultValue={["relevance"]} name="sortBy">
                              <CompactSelect.Option value="relevance">
                                Relevance
                              ...
                              <CompactSelect.Option value="amount-desc">
                                Amount (high to low)
                              </CompactSelect.Option>
                              <CompactSelect.Option value="amount-asc">
                                Amount (low to high)
                              </CompactSelect.Option>
                        ...
                        <Table.BodyRow as="tr" key={transaction.id}>
                          <Table.BodyCell as="th" justifySelf="start">
                            <Table.DoubleLineLayout
                              supplementaryData={`Ref: ${transaction.reference}`}
                            >
                              <Table.PrimaryAction href="#">
                                {transaction.payer}
                              </Table.PrimaryAction>
                            </Table.DoubleLineLayout>
                          </Table.BodyCell>
