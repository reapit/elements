...
## React usage with form

Example of rendering form content within the drawer. Leverages an `InputWrapHalf` component in conjuction with the `FormLayout` to ensure inputs are at a consistent width across all resolutions, since the Drawer is fixed width.

<Canvas of={DrawerStories.ReactUsageWithForm} />
