...
/**
 * When the `SideBar` is collapsed, the menu group's main label will be completely hidden. Importantly, the menu group's
 * label will still be available in the accessibility tree despite not being visible.
 */
...
/**
 * Also, when the `SideBar` is collapsed, the menu group can still be selected, but it will not be expanded. Again, the
 * label will still be available in the accessibility tree. Clicking on the group will cause the `SideBar` to expand, and
 * the group to open, though this behaviour is handled by the `SideBar` component itself, not the group.
 */
