...
The component does not render children, rather it accepts a list of options and maps through them on render.
...
<Canvas of={TabsStories.Uncontrolled} />
...
import {BasicUsage} from '../basic/tabs.stories'
