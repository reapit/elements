...
test('renders an image for the image type', () => {
  render(<FileUploaderFileCardLeadingElement type="image" src="thumb.jpg" alt="A preview of Invoice.pdf" />)
  expect(screen.getByRole('img', { name: 'A preview of Invoice.pdf' })).toHaveAttribute('src', 'thumb.jpg')
})
