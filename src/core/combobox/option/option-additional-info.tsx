 ...
 */
export function ComboboxOptionAdditionalInfo({ badge, children, icon, ...rest }: ComboboxOptionAdditionalInfo.Props) {
  return (
    <ElComboboxOptionAdditionalInfo {...rest}>
      {icon && <ElComboboxOptionAdditionalInfoIconContainer>{icon}</ElComboboxOptionAdditionalInfoIconContainer>}
