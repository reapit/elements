...
test("accepts other classes", () => {
  ...
  const { container } = render(
    <TableCellCheckbox aria-label="My checkbox" className="custom-class" />,
  );
  expect(container.querySelector(".el-table-cell-checkbox")).toHaveClass(
    "el-table-cell-checkbox custom-class",
  );
});
