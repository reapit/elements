 ...
 */
export function OfficeItem({ badge, children, ...rest }: OfficeItem.Props) {
  const badgeId = useId()
  const labelId = useId()
  ...
  return (
    ...
    <ElOfficeItem {...rest} aria-labelledby={labelId} aria-details={ariaDetails} role="option" type="button">
      <ElOfficeItemLeftContent>
