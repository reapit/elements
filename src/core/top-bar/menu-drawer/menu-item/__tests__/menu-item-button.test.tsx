...
test(`combines the .${elTopBarMenuDrawerMenuItem} and consumer-supplied classes correctly`, () => {
  render(<TopBarMenuDrawerMenuItemButton className="my-custom-class">Sign Out</TopBarMenuDrawerMenuItemButton>)
...
test('triggers onClick handler when clicked', () => {
  ...
  render(<TopBarMenuDrawerMenuItemButton onClick={handleClick}>Sign Out</TopBarMenuDrawerMenuItemButton>)
