...
test('renders a paragraph element', () => {
  const { container } = render(<FormLayoutSectionDescription>content</FormLayoutSectionDescription>, {
    wrapper: Wrapper,
  })
...
test('renders children as the paragraph text', () => {
  render(<FormLayoutSectionDescription>Section description text</FormLayoutSectionDescription>, { wrapper: Wrapper })
  expect(screen.getByText('Section description text')).toBeVisible()
})

test('forwards additional props to the underlying element', () => {
  render(<FormLayoutSectionDescription data-testid="description">content</FormLayoutSectionDescription>, {
    wrapper: Wrapper,
  })
...
test('consumer-supplied id overrides the auto-wired descriptionId', () => {
  render(<FormLayoutSectionDescription id="custom-id">Section description</FormLayoutSectionDescription>, {
    wrapper: Wrapper,
  })
...
test('throws when rendered outside a FormLayout or FormLayout.Section', () => {
  expect(() => render(<FormLayoutSectionDescription>Section description</FormLayoutSectionDescription>)).toThrow(
