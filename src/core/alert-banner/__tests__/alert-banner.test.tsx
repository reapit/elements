...
test('renders an alert banner element', () => {
  ...
  render(
    <AlertBanner icon={<InfoIcon />} variant="info" onDismiss={onDismiss} actions={<button>Learn More</button>}>
...
test.each(['error', 'warning', 'info'] as const)('applies correct data-variant attribute for %s variant', (variant) => {
