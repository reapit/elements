  ...
  render: function Example() {
    ...
    return (
      <>
        ...
        <button command="show-modal" commandfor="gallery">
          Open gallery
        </button>
        <GalleryViewer id="gallery">
          <GalleryViewer.Header>10 High Street, Great Horwood, Buckinghamshire, MK17 0QL</GalleryViewer.Header>
