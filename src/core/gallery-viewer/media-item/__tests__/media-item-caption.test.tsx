...
test('renders a figcaption element', () => {
  const { container } = render(<GalleryViewerMediaItemCaption>Front view</GalleryViewerMediaItemCaption>)
...
test('forwards additional props', () => {
  render(<GalleryViewerMediaItemCaption data-testid="caption">Caption</GalleryViewerMediaItemCaption>)
