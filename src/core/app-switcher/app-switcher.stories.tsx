 ...
 *    <AppSwitcher.YourAppsMenuGroup>
 *      {ids.map((productId) => (
 *        <AppSwitcher.ProductMenuItem key={productId} productId={productId} href={href} />
 *      ))}
 *    </AppSwitcher.YourAppsMenuGroup>
 *    <AppSwitcher.Divider />
 *  </>
 ...
 *
 * The following example shows how `getDisplayableProductsForExploreGroup` can be used to render the Explore
 * menu group with the correct products. This is the same logic employed by this story.
 *
 * ```tsx
