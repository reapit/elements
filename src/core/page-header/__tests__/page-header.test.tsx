...
test('renders a header element', () => {
  render(<PageHeader size="fluid" title="Page title" />)
...
test('displays breadcrumbs when provided', () => {
  render(<PageHeader size="fluid" title="Page title" navigation={<span>Breadcrumbs</span>} />)
  expect(screen.getByText('Breadcrumbs')).toBeVisible()
})

test('displays leading element when provided', () => {
  render(<PageHeader size="fluid" title="Page title" leadingElement={<span>Leading element</span>} />)
  expect(screen.getByText('Leading element')).toBeVisible()
})

test('displays subtitle when provided', () => {
  render(<PageHeader size="fluid" title="Page title" subtitle={<span>Subtitle</span>} />)
  expect(screen.getByText('Subtitle')).toBeVisible()
})

test('displays supplementary info when provided', () => {
  render(<PageHeader size="fluid" title="Page title" supplementaryInfo={<span>Supplementary Info</span>} />)
