...
export const TextInput = forwardRef<HTMLInputElement, TextInput.Props>(
  (
    ...
    return (
      ...
      >
        {showPrefix && (
          <ElTextInputAffixContainer data-position="before">{prefix}</ElTextInputAffixContainer>
        )}
        {showLeadingIcon && (
          <ElTextInputIconContainer data-position="before">{leadingIcon}</ElTextInputIconContainer>
        )}
        <ElTextInput
          {...rest}
        ...
        {showTrailingIcon && (
          <ElTextInputIconContainer data-position="after">{trailingIcon}</ElTextInputIconContainer>
        )}
        {showSuffix && (
          <ElTextInputAffixContainer data-position="after">{suffix}</ElTextInputAffixContainer>
        )}
        {showSpinner && (
