...
test('forwards additional props to the element', () => {
  render(<AtAGlanceCardDescription data-testid="custom-desc">Test Description</AtAGlanceCardDescription>, {
    wrapper: (props) => <Wrapper {...props} as="article" />,
  })
...
test('applies custom className', () => {
  render(<AtAGlanceCardDescription className="custom-class">Test Description</AtAGlanceCardDescription>, {
    wrapper: (props) => <Wrapper {...props} as="article" />,
  })
