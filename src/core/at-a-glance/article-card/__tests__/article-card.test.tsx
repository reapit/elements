...
test('displays description when provided', () => {
  render(<AtAGlanceArticleCard label="Test Label" displayValue="Test Value" description="Test Description" />)
...
test('displays icon when provided', () => {
  render(<AtAGlanceArticleCard label="Test Label" displayValue="Test Value" icon={<svg data-testid="test-icon" />} />)
...
test('applies custom styles', () => {
  render(<AtAGlanceArticleCard label="Test Label" displayValue="Test Value" style={{ color: 'red' }} />)
  expect(screen.getByRole('article')).toHaveStyle({ color: 'red' })
})

test('forwards additional props to the article', () => {
  render(<AtAGlanceArticleCard label="Test Label" displayValue="Test Value" data-testid="custom-article" />)
