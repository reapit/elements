...
test('displays description when provided', () => {
  render(<AtAGlanceButtonCard label="Test Label" displayValue="Test Value" description="Test Description" />)
...
test('displays icon when provided', () => {
  render(<AtAGlanceButtonCard label="Test Label" displayValue="Test Value" icon={<svg data-testid="test-icon" />} />)
...
test('applies custom styles', () => {
  render(<AtAGlanceButtonCard label="Test Label" displayValue="Test Value" style={{ color: 'red' }} />)
...
test('does not call onClick when disabled', () => {
  ...
  render(<AtAGlanceButtonCard label="Test Label" displayValue="Test Value" onClick={handleClick} disabled />)
...
test('forwards additional props to the button', () => {
  render(<AtAGlanceButtonCard label="Test Label" displayValue="Test Value" data-testid="custom-button" />)
