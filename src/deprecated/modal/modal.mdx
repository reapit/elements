...
```tsx
import { Modal } from '@reapit/elements/deprecated/modal'
...
const MyModal = () => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onModalClose={() => setIsOpen(false)} title="Welcome to the demo modal">
...
```tsx
import { Dialog } from '@reapit/elements/core/dialog'
