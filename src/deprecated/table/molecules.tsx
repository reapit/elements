...
/** @deprecated */
export const DeprecatedTableHeadersRow: FC<HTMLAttributes<HTMLDivElement>> = ({
  children,
  ...rest
}) => {
...
/** @deprecated */
export const DeprecatedTableHeader: FC<HTMLAttributes<HTMLDivElement>> = ({
  children,
  ...rest
}) => {
...
export const DeprecatedTableCell: FC<DeprecatedTableCellProps> = ({
  ...
  return (
    <ElDeprecatedTableCell className={combinedClassname} {...rest}>
      ...
      <ElDeprecatedTableCellContent data-narrow-label={narrowLabel}>
        {children}
      </ElDeprecatedTableCellContent>
    </ElDeprecatedTableCell>
  );
...
/** @deprecated */
export const TableCtaTriggerCell: FC<TableCtaTriggerCellProps> = ({
  icon,
  children,
  onClick,
  ...rest
...
/** @deprecated */
export const TableExpandableRow: FC<TableExpandableRowProps> = ({
  isOpen,
  className,
  children,
  ...rest
...
/** @deprecated */
export const DeprecatedTableSortHeader: FC<DeprecatedTableSortHeaderProps> = ({
  children,
  ...rest
}) => {
  return (
