...
export const Text3XL: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elText3XL} {...props} />
);

/** @deprecated */
export const Text2XL: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elText2XL} {...props} />
);

/** @deprecated */
export const TextXL: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elTextXL} {...props} />
);

/** @deprecated */
export const TextL: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elTextL} {...props} />
);
...
export const TextSM: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elTextSM} {...props} />
);

/** @deprecated */
export const TextXS: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elTextXS} {...props} />
);

/** @deprecated */
export const Text2XS: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elText2XS} {...props} />
);

/** @deprecated */
export const Title: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elTitle} tag="h1" {...props} />
);

/** @deprecated */
export const Subtitle: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elSubtitle} tag="h2" {...props} />
);

/** @deprecated */
export const BodyText: FC<TypographyProps> = (props) => (
  <TaggedTypography baseClass={elBodyText} tag="p" {...props} />
);
