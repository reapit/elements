---
name: code-review
description: Review-specific guidance for @reapit/elements pull requests — what to flag, what to skip, and how to avoid false positives. Use this skill whenever reviewing a pull request or diff in this repository, whether as the primary check or a second opinion alongside other automated review.
---
...
Do not raise these — they create noise and erode trust in the review:
