// url=https://www.figma.com/design/6CaivqdlTX0UkFYJkpBKDu/Reapit-DS?node-id=17707-8359&m=dev
...
const label = (function () {
  const nestedLayer55 = figma.selectedInstance.findInstance("List item");
  return {
    value: nestedLayer55.type !== "ERROR" ? nestedLayer55.getString("Label") : undefined,
  };
})();
