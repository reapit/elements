...
export namespace PaginationLinkBase {
  ...
  export interface AsAnchorProps
    extends CommonProps, Omit<HTMLAttributes<HTMLAnchorElement>, AttributesToOmit> {
    as: "a";
    href: string;
  }

  export interface AsButtonProps
    extends CommonProps, Omit<ButtonHTMLAttributes<HTMLButtonElement>, AttributesToOmit> {
    as: "button";
  }
