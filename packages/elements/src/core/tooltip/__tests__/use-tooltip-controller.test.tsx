...
test("calls showPopover on anchor focus when focus-visible", () => {
  ...
  triggerElement.matches = vi
    .fn()
    .mockReturnValue(true) as unknown as typeof triggerElement.matches;
...
test("calls hidePopover on anchor mouseleave when not focus-visible", () => {
  ...
  triggerElement.matches = vi
    .fn()
    .mockReturnValue(false) as unknown as typeof triggerElement.matches;
