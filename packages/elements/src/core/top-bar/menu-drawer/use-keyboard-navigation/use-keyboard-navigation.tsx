...
/**
 * Returns a key down event handler that facilitates navigation through the menu drawer's menu items via arrow keys,
 * closes menu groups when Escape is pressed, and activates links when the space key is pressed.
 */
export function useTopBarMenuDrawerKeyboardNavigation(): KeyboardEventHandler<HTMLDivElement> {
