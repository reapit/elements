...
test('renders as h1 when as="h1" is passed', () => {
  render(<FormLayoutSectionTitle as="h1">Section title</FormLayoutSectionTitle>, {
    wrapper: Wrapper,
  });
...
test('renders as h3 when as="h3" is passed', () => {
  render(<FormLayoutSectionTitle as="h3">Section title</FormLayoutSectionTitle>, {
    wrapper: Wrapper,
  });
...
test("forwards additional props to the underlying element", () => {
  render(<FormLayoutSectionTitle data-testid="title">content</FormLayoutSectionTitle>, {
    wrapper: Wrapper,
  });
...
test("consumer-supplied id overrides the auto-wired titleId", () => {
  render(<FormLayoutSectionTitle id="custom-id">Section title</FormLayoutSectionTitle>, {
    wrapper: Wrapper,
  });
