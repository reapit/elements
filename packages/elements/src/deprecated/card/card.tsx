...
/** @deprecated */
export const CardWrap: FC<CardBaseProps> = ({ children, ...rest }) => (
  <ElCardWrap {...rest}>{children}</ElCardWrap>
);
...
/** @deprecated */
export const CardList: FC<CardBaseProps> = ({ children, ...rest }) => (
  <ElCardList {...rest}>{children}</ElCardList>
);
