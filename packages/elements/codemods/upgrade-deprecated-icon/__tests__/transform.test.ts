...
`;
    ...
    expect(output).toContain(
      'TODO: Icon "drawClose" has been removed in v5 and has no replacement',
    );
  });
...
`;
    ...
    expect(output).toContain(
      'TODO: Icon "placeholderLarge" has been removed in v5 and has no replacement',
    );
  });
...
`;
    const output = transform(input);
    expect(output).toContain(
      '// TODO: Icon "reapitLogoSmall" has been removed in v5 and has no replacement',
    );
