...
test('transforms multiple named imports', () => {
  ...
  const output = transform(input, 'test.tsx')
  expect(output).toContain(`import { Combobox, ComboboxPopup } from '@reapit/elements/utils/combobox'`)
  expect(output).not.toContain('/core/combobox')
})
...
test('transforms mixed value and type imports', () => {
  ...
  const output = transform(input, 'test.tsx')
  expect(output).toContain(`import { Combobox, type ComboboxProps } from '@reapit/elements/utils/combobox'`)
  expect(output).not.toContain('/core/combobox')
})
...
test('preserves import alias', () => {
  ...
  const output = transform(input, 'test.tsx')
  expect(output).toContain(`import { Combobox as MyCombobox } from '@reapit/elements/utils/combobox'`)
  expect(output).not.toContain('/core/combobox')
})
...
test('preserves alias on type import', () => {
  ...
  const output = transform(input, 'test.tsx')
  expect(output).toContain(`import { type ComboboxProps as Props } from '@reapit/elements/utils/combobox'`)
  expect(output).not.toContain('/core/combobox')
})
