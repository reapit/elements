...
describe("type imports", () => {
  test("transforms type-only import statement", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import type { DeprecatedButtonProps as ButtonProps } from '@reapit/elements'`,
    );
  });
...
describe("aliased imports", () => {
  ...
  test("preserves custom type alias", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import type { DeprecatedButtonProps as MyButtonProps } from '@reapit/elements'`,
    );
  });
...
describe("already deprecated imports", () => {
  ...
  test("does not transform mixed deprecated and non-deprecated", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import { DeprecatedButton, DeprecatedBadge as Badge } from '@reapit/elements'`,
    );
  });
});
...
describe("facade package support", () => {
  ...
  test("transforms facade package with subpath", () => {
    ...
    expect(output).toBe(
      `import { DeprecatedButton as Button } from '@company/design-system/elements'`,
    );
  });
...
describe("CSS classes", () => {
  ...
  test("transforms layout CSS classes", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import { elDeprecatedMainContainer as elMainContainer } from '@reapit/elements'`,
    );
  });
  ...
  test("transforms pagination CSS classes", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import { elDeprecatedPaginationPrimary as elPaginationPrimary } from '@reapit/elements'`,
    );
  });
...
describe("TextArea to Textarea rename", () => {
  ...
  test("renames inline type TextAreaProps", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import { Textarea as TextArea, type TextareaProps as TextAreaProps } from '@reapit/elements'`,
    );
  });
  ...
  test("renames TextArea together with other v4 components", () => {
    ...
    const output = transform(input);
    expect(output).toBe(
      `import { DeprecatedButton as Button, Textarea as TextArea } from '@reapit/elements'`,
    );
  });
